...
set proj_name "axi4_stream_fifo"

# Set the block design name
set bd_name "design_1"

variable script_file
set script_file "axi4_stream_fifo.tcl"
...
add_files -fileset sources_1 "\
    ...
    ${hdl_sources_paths}/dual_port_ram_fifo.sv \
    ${hdl_sources_paths}/axi4_stream_fifo.sv \
    " \
-norecurse

add_files -fileset sim_1 "\
    ${hdl_sources_paths}/tb_axi4_stream_fifo.sv \
    " \
-norecurse

set_property top tb_axi4_stream_fifo [get_filesets sim_1]
...
create_bd_port -dir I -type clk -freq_hz 210000000 clk_o
create_bd_port -dir I -type rst rst_ni
set_property CONFIG.ASSOCIATED_RESET {rst_ni} [get_bd_ports /clk_i]

#Connect ports
connect_bd_net [get_bd_ports clk_i] [get_bd_pins axi4stream_vip_master_0/aclk]
connect_bd_net [get_bd_ports clk_o] [get_bd_pins axi4stream_vip_slave_0/aclk]
connect_bd_net [get_bd_ports rst_ni] [get_bd_pins axi4stream_vip_master_0/aresetn]
connect_bd_net [get_bd_ports rst_ni] [get_bd_pins axi4stream_vip_slave_0/aresetn]
